...
namespace ItemBrowser.Entries.Defaults.Sources {
	public class NaturalSpawnRespawn : ObjectEntry {
		public override ObjectEntryCategory Category => new(ObjectEntryType.Source, "ItemBrowser:ObjectEntry/NaturalSpawnRespawn", ObjectID.MeadowBush, 4800);
					...
					foreach (var spawn in entry.spawns) {
						...
						foreach (var variation in variations) {
							foreach (var tileset in tilesets) {
								registry.Register(spawn.objectID, variation.value, new NaturalSpawnRespawn {
