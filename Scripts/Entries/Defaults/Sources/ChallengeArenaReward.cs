...
namespace ItemBrowser.Entries.Defaults.Sources {
	public class ChallengeArenaReward : ObjectEntry {
		public override ObjectEntryCategory Category => new(ObjectEntryType.Source, "ItemBrowser:ObjectEntry/ChallengeArenaReward", ObjectID.AlienChest, 3750);
		...
		public class Provider : ObjectEntryProvider {
			...
			public override void Register(ObjectEntryRegistry registry, List<(ObjectData ObjectData, GameObject Authoring)> allObjects) {
				...
				registry.Register(ObjectID.AlienChest, 0, new ChallengeArenaReward {
					Amount = (1, 1),
					Chance = 1f,
					ChanceForOne = 1f,
					Rolls = (1, 1)
				});
				registry.Register(ObjectID.CrystalMerchantSpawnItem, 0, new ChallengeArenaReward {
					Amount = (1, 1),
					Chance = 1f,
					ChanceForOne = 1f,
					Rolls = (1, 1),
				...
				foreach (var gem in GemstoneTypes) {
					registry.Register(gem.Id, 0, new ChallengeArenaReward {
						Amount = (2, 3),
						Chance = 1f,
						ChanceForOne = 1f,
						Rolls = (1, 1),
				...
				foreach (var drop in LootUtils.GetLootTableContents(LootTableID.AlienEventTerminal)) {
					registry.Register(drop.ObjectId, 0, new ChallengeArenaReward {
						Chance = drop.Chance,
