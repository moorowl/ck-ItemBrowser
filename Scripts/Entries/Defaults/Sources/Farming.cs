...
namespace ItemBrowser.Entries.Defaults.Sources {
	public class Farming : ObjectEntry {
		public override ObjectEntryCategory Category => new(ObjectEntryType.Source, "ItemBrowser:ObjectEntry/Farming", ObjectID.HeartBerrySeed, 4900);
		...
		public class Provider : ObjectEntryProvider {
			public override void Register(ObjectEntryRegistry registry, List<(ObjectData ObjectData, GameObject Authoring)> allObjects) {
				foreach (var (objectData, authoring) in allObjects) {
					...
					registry.Register(plantAuthoring.objectToDropWhenHarvested, 0, new Farming {
					...
					if (turnsIntoPlantVariationRare > 0) {
						...
						registry.Register(rarePlantAuthoring.objectToDropWhenHarvested, 0, new Farming {
							Seed = objectData.objectID,
