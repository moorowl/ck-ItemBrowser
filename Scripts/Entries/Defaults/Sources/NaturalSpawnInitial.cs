...
namespace ItemBrowser.Entries.Defaults.Sources {
	public class NaturalSpawnInitial : ObjectEntry {
		public override ObjectEntryCategory Category => new(ObjectEntryType.Source, "ItemBrowser:ObjectEntry/NaturalSpawnInitial", ObjectID.Bush, 4700);
					...
					foreach (var spawn in entry.spawns) {
						...
						foreach (var variation in variations) {
							foreach (var tileset in tilesets) {
								registry.Register(spawn.objectID, variation.value, new NaturalSpawnInitial {
